...
//   const handleStatusChange = async (manualRequestId) => {
...
//       try {
//         await dispatch(updateManualRequestStatus({ manualRequestId, newStatus: selectedStatus }));
//         // Optional: Handle any logic that needs to be executed after the status is successfully updated
